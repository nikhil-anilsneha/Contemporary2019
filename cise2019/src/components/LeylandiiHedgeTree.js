...
import './tree.css';
// import LeylandiiHedgeTreePic from "./images/LeylandiiHedgeTreePic.jpg";

class LeylandiiHedgeTree extends Component {
    render() { 
        return (
            <div class = "LeylandiiHedgeTreePage">

                <h1>Leylandii (Green) Hedge Tree</h1>

                <br></br>
                
                {/* <img src={LeylandiiHedgeTreePic} alt="LeylandiiHedgeTreePic" className="LeylandiiHedgeTreePic"></img> */}
...
export default LeylandiiHedgeTree;